...
fun main() {
    application {
        ...
        program {
            ...
            val imageDescription = ai.imageChat(image, "Describe the image in 8 sentences. Don't use lists or text formatting. Don't mention the image itself only what is on the image.")
