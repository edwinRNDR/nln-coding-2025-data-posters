...
fun main() = application {
    ...
    program {
        googleNewsSetApiKey("YOUR_KEY_HERE")
        //val archive = googleNewsSequence(GoogleNewsEndPoint.TopHeadlines, country = "nl").iterator()
        val archive = googleNewsSequence(GoogleNewsEndPoint.Everything, query = "depression").iterator()
