    ...
    program {
        ...
        fun makePoster(article: LoadedArticle): Composite =
            compose {
                ...
                layer {
                    val rhyme = ai.chat("Write a single sentence rhyme based on the following text: \"${article.texts.firstOrNull()?:""}\". Output your answer only, don't use any formatting.").trim()
                    draw {
