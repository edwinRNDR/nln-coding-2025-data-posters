    ...
    program {
        ...
        fun makePoster(article: LoadedArticle): Composite =
            compose {
                ...
                layer {
                    val keywords = ai.chat("Extract 3 keywords from the text: \"${article.texts.firstOrNull()?:""}\". Output single word keywords only, output each keyword on a separate line. ",)
                    draw {
